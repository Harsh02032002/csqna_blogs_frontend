    ...
    <div className={`flex flex-col h-full bg-white ${mobile ? '' : 'border-r border-slate-200/80'}`}>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/50">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-xs text-red-650 bg-red-50 hover:bg-red-100 rounded-xl transition-all duration-200 font-bold border border-red-200/50 hover:border-red-300"
        >
          <LogOut size={14} />
          Sign Out
        </button>
